...
puts "Creating 7 Users..."
  user1 = User.create!(username: "Maximilien", avatar:"http://bit.ly/2EF3rJz", email: "maximilien@gmail.com", password: "123456", is_artist: true, location: "New York", bio: "An artwork can be accommodated in an interior wall, in the living room, bedroom, kitchen or in a studio and showroom. The service of indoor artwork extends to both private clients, companies and public organizations.")
  user2 = User.create!(username: "Tanguy", avatar:"http://bit.ly/2Hx6P7l", email: "tanguy@homail.com", password: "123456",  is_artist: true, location: "Rennes", bio:  "Drawing and painting on walls. Interior and exterior spaces. Colorful or monotone, aerosol, acrylic paint and/ or brush work. Artistic approach, client-request oriented and several years of experience.")
  ...
  user4 = User.create!(username: "Alexis", avatar:"http://bit.ly/2Cx5NV6", email: "alexis@bing.fr", password: "123456",  is_artist: true, location: "Berlin", bio: "The process for painting on walls is very similar to painting canvases , except there is obviously a difference in scale. I have painted walls for bars, clubs, Cafe's, shop shutters, public spaces and corporate events. This is a great way of brightening up a work space and adding more colour or vibrance to a blank wall.")
  user5 = User.create!(username: "Hugo", avatar:"http://bit.ly/2CdjigW", email: "hugo@yahoo.com", password: "123456",  is_artist: true, location: "Paris", bio: "I do free and commissioned artworks. For clubs, festivals, events, restaurants, products etc. Indoor and outdoor - no problem. Any size is possible!")
  user6 = User.create!(username: "Benoit", avatar:"http://bit.ly/2BGEKKl", email: "benoit@gmail.fr", password: "123456",  is_artist: true, location: "New York", bio: "BustArt paints a unique mix of graffiti techniques, lettering and pop-comics styles. He is specialized in stencils, lettering, portraits, markers, spray can and freehand painting.")
  user7 = User.create!(username: "Alexandre", avatar:"http://bit.ly/2sGx33D", email: "Alexandre@orange.fr", password: "123456",  is_artist: true, location: "Paris", bio: "Acrylics | Spray Paint | Markers | Stencils. Offering worldwide mural and object paintings on literally every paintable surface. Walls, cars, skateboards, shoes, clothes, vinyltoys, unicorns – you name it. Interior and exterior. From concept to sketch to the final painting.")
puts "Done!"
